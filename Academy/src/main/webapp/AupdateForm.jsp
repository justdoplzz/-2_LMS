		...
		<div class="col-lg-8 bg-box3">
			...
			<h3 class="title2" >자료실</h3>
				<div class="write-box">
					...
					<form method="post" action="<%=request.getContextPath()%>/AupdateProc.do">
						<input type="hidden" value="<%=session.getAttribute("userId")%>" name="userId">
						<input type="hidden" value="${avo.boardNo }" name="boardNo">
						<input type="text" class="orange_text" placeholder="제목" name="title" value="${avo.title}"> <br>
						<textarea class="orange_area" placeholder="내용" name="content">${avo.content}</textarea>
